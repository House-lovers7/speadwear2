...
export const commentItemPost = (userId, itemId) => `${DEFAULT_API_LOCALHOST}/users/${userId}/items/${itemId}/comments`
//LikeItem
export const likeItemIndex = (userId, itemId, likeItemId) =>
  `${DEFAULT_API_LOCALHOST}/users/${userId}/items/${itemId}/likeItems/${likeItemId}`
export const likeItemPost = (userId, itemId) => `${DEFAULT_API_LOCALHOST}/users/${userId}/items/${itemId}/likeItems`
//LikeCoordinate
...
export const likeCoordinatePost = (userId, coordinateId) =>
